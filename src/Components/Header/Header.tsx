      ...
      <>
        <div className="header">
            <div className="head-title">
                ...
                <p style={{fontSize:12}}>London</p>
            </div>
            <div className="head-menu">
                <Select  className='sel' style={{width:200, color:"#218256"}}
                                    placeholder="Select"
                                    >
                                    {[
                                        "Applied",
                                        ...
                                        <Select.Option  value={question} key={question}>
                                           <div className="drop-down">
                                            <h4> {question}</h4> 
                                            <div className="drop-dwn-dot">44</div>
                                            </div>
                                        </Select.Option>
                                        );
                                    })}
            ...
            <div className="head-sec3">
                ...
                <div>
                    <Input className="head-drop" value={"Move To Video Interview"} addonAfter={<DownOutlined />}></Input>
                </div>
            </div>
            <div></div>
        </div>
